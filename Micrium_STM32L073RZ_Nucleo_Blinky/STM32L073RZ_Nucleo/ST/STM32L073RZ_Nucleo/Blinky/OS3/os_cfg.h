...
#define OS_CFG_DYN_TICK_EN              1u   /* Enable (1) the Dynamic Tick                                           */
#define OS_CFG_INVALID_OS_CALLS_CHK_EN  1u   /* Enable (1) checks for invalid kernel calls                            */
...
#define OS_CFG_TASK_IDLE_EN             1u   /* Include (1) the idle task                                             */
...
#define OS_CFG_TASK_STK_REDZONE_EN      0u   /* Enable (1) stack redzone                                              */
...
#define OS_CFG_TASK_TICK_EN             1u   /* Include (1) the kernel tick task                                      */
...
#define OS_CFG_TMR_DEL_EN               1u   /* Enable (1) or Disable (0) code generation for OSTmrDel()              */
                                             ...
                                             /* ------------------------- TRACE RECORDER ---------------------------- */
#define OS_CFG_TRACE_EN                 0u   /* Enable (1) uC/OS-III Trace instrumentation                            */
#define OS_CFG_TRACE_API_ENTER_EN       0u   /* Enable (1) uC/OS-III Trace API enter instrumentation                  */
#define OS_CFG_TRACE_API_EXIT_EN        0u   /* Enable (1) uC/OS-III Trace API exit  instrumentation                  */
...
*/
                                             /* ----------------------------- MONITORS ------------------------------ */
#define OS_CFG_MON_EN                   0u   /* Enable (1) code generation for MONITORS                     */
#define OS_CFG_MON_DEL_EN               0u   /* Include (1) code for OSMonDel()                         */
